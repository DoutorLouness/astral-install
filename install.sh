...
# ==========================================
# INSTALADOR MODULAR - ASTRAL CLOUD
# ==========================================
...
EOF
    ...
    while true; do
        ...
        # Leitura forçada do teclado (Ignora o pipe do curl)
        read -r -p " Opção: " OPCAO < /dev/tty
        
        # Limpa quebras invisíveis do Windows
        OPCAO="${OPCAO//[$'\t\r\n ']}"
...
# Inicia o script com todos os argumentos
main "$@"
